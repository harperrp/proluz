  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <RoleProtectedRoute roles={["ADMIN", "CITY_HALL_ADMIN", "SECRETARY", "TECHNICAL"]}>
              <Dashboard />
            </RoleProtectedRoute>
          </ProtectedRoute>
        }
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <RoleProtectedRoute roles={["ADMIN", "CITY_HALL_ADMIN", "SECRETARY"]}>
              <DashboardComplaints />
            </RoleProtectedRoute>
          </ProtectedRoute>
        }
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <RoleProtectedRoute roles={["ADMIN", "CITY_HALL_ADMIN", "TECHNICAL"]}>
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <RoleProtectedRoute roles={["ADMIN", "CITY_HALL_ADMIN"]}>
              <DashboardUsers />
            </RoleProtectedRoute>
          </ProtectedRoute>
        }
